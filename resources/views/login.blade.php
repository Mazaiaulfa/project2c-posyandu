...
<meta name="theme-color" content="#712cf9S">
...
<main class="form-signin w-100 m-auto">
  <form>
    ...
    <h1 class="h3 mb-3 fw-normal center text-center">Please sign in</h1>
    ...
    <p class="mt-5 mb-3 text-body-secondary text-center">&copy; copyright {{date("Y")}}</p>
  </form>
</main>
